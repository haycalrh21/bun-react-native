...
CREATE TABLE "public"."product_image" (
    ...
    CONSTRAINT "product_image_pkey" PRIMARY KEY ("_id")
);
...
-- AddForeignKey
ALTER TABLE "public"."product" ADD CONSTRAINT "product_createdBy_fkey" FOREIGN KEY ("createdBy") REFERENCES "public"."user"("_id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."product_image" ADD CONSTRAINT "product_image_productId_fkey" FOREIGN KEY ("productId") REFERENCES "public"."product"("_id") ON DELETE CASCADE ON UPDATE CASCADE;
